    ...
    while (flag)
    {
        switch (_circlicState)
        {
            case CirclicState::SEND_FIRST:
                ...
                //if (!sendCoordinates(firstPoint)) return; => Danila works on new movement algorithms.
                break;
            ...
            case CirclicState::SEND_SECOND:
                ...
                //if (!sendCoordinates(secondPoint)) return; => Danila works on new movement algorithms.
                break;
                             ...
                             const int numberOfSteps)
{
    ...
    for (int i = 0; i < numberOfSteps; ++i)
    {
        ...
        //if (!sendCoordinates(robotData)) return; => Danila works on new movement algorithms.
    }
